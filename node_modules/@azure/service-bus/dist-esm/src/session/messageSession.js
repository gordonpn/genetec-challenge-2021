...
import { calculateRenewAfterDuration, convertTicksToDate, StandardAbortMessage } from "../util/utils";
...
export class MessageSession extends LinkEntity {
    ...
    constructor(context, entityPath, _providedSessionId, options) {
        ...
        this._batchingReceiverLite = new BatchingReceiverLite(context, entityPath, (_abortSignal) => __awaiter(this, void 0, void 0, function* () {
            return this.link;
        }), this.receiveMode);
